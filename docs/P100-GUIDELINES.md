...
|-------|-------|---------|--------|--------|-------------|--------------|-----|
| `web/xs` | 320...649px | 6 | 16px | 12px | Stretch | Auto | Smartphones |
| `web/sm` | 650...899px | 12 | 32px | 16px | Stretch | Auto | Portrait-oriented tablets |
| `web/md` | 900...1199px | 12 | 32px | 16px | Stretch | Auto | Landscape-oriented tablets |
| `web/lg` | 1200...1599px | 12 | 80px | 24px | Stretch | Auto | Small laptops |
| `web/xl` | 1600...2560px | 12 | 0px | 24px | Center | 98px | Desktop monitors |

### Email layout grid

> Email template width is capped at 600px on wide screens.

| Token | Range | Columns | Margin | Gutter | Type | Column Width | Use |
|-------|-------|---------|--------|--------|------|--------------|-----|
| `email/xs` | 320...649px | 6 | 16px | 12px | Stretch | Auto | Emails on smartphones |
| `email/sm` | 650...2560px | 6 | 0px | 12px | Center | 90px | Emails on wide screens |